...
if __name__ == "__main__":
    ...
    # Example input
    input_str = """Select the single, most appropriate class for <bbox> from: dining table, cow, spoon, potted plant, zebra, donut, traffic light, backpack, vase, sports ball, person, apple, chair, bicycle, pizza, remote, tennis racket, bench, boat, motorcycle, bottle, broccoli, suitcase, dog, orange, skis, cake, umbrella, cell phone, bowl, wine glass, surfboard, handbag, sheep, tie, banana, sink, kite, clock, cup, giraffe, bus, knife, bird, elephant, truck, book, car, tv, carrot."""
    input_image = "/nfs/turbo/coe-chaijy/xuejunzh/data/validation/image/mixed-images/raw/COCO/000000567898.jpg"
    bbox_img = [[228,54,303,127]]  # Example bbox coordinates
