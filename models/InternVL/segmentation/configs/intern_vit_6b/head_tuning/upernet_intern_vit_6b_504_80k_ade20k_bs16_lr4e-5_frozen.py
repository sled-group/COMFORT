...
model = dict(
    ...
    decode_head=dict(
        num_classes=150, channels=1536, in_channels=[3200, 3200, 3200, 3200]
    ),
    auxiliary_head=dict(num_classes=150, channels=1536, in_index=1, in_channels=3200),
...
if deepspeed:
    checkpoint_config = dict(
        deepspeed=deepspeed, by_epoch=False, interval=1000, max_keep_ckpts=2
    )
else:
...
custom_hooks = [
    dict(type="ToBFloat16Hook", priority=49),
]
