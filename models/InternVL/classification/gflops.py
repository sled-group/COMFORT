...
configs = {
    "a": {"embed_dim": 3968, "num_heads": 62, "mlp_ratio": 4, "depth": 32},
    "e": {"embed_dim": 3200, "num_heads": 50, "mlp_ratio": 4, "depth": 48},
    "f": {"embed_dim": 3200, "num_heads": 25, "mlp_ratio": 4, "depth": 48},
    "g": {"embed_dim": 2496, "num_heads": 39, "mlp_ratio": 8, "depth": 48},
    "i": {"embed_dim": 2816, "num_heads": 44, "mlp_ratio": 4, "depth": 64},
    "m": {"embed_dim": 2496, "num_heads": 39, "mlp_ratio": 4, "depth": 80},
}
...
def get_flops(model, input_shape):
    ...
    for i in range(model.depth):
        flops += sa_flops(H // model.patch_size, W // model.patch_size, model.embed_dim)
