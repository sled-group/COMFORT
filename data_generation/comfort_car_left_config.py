...
COMFORT_LEFT_DEFAULT_CONFIG = {
    "num_distractors": 0,
    "name": None,
    "num_steps": 37
}

COMFORT_LEFT_BASKETBALL_AND_CHAIR = {
    # render config
...
COMFORT_LEFT_BASKETBALL_AND_DOG = {
    # render config
...
COMFORT_LEFT_BASKETBALL_AND_SOFA = {
    # render config
...
COMFORT_LEFT_BASKETBALL_AND_BED = {
    # render config
...
COMFORT_LEFT_BASKETBALL_AND_LAPTOP = {
    # render config
...
COMFORT_LEFT_BASKETBALL_AND_DUCK = {
    # render config
...
COMFORT_LEFT_BASKETBALL_AND_HORSE = {
    # render config
...
COMFORT_LEFT_BASKETBALL_AND_CAR = {
    # render config
    "variation": "default",
    "num_steps": 37,
    "radius": 3.2,
...
COMFORT_LEFT_BASKETBALL_AND_BENCH = {
    # render config
...
COMFORT_LEFT_BASKETBALL_AND_BICYCLE = {
    # render config
